...
class Main():
  ...
  def easy_pulls_documentation(self):
    spinner = Halo(text='Initializing GitHub client', text_color= 'yellow', color='magenta', spinner='hearts')
    try:
      spinner.start()
      ...
      if self.git != None:
        ...
        spinner.start("Fetching issue data")
        self._load_records()
        spinner.succeed()
  ...
  def _load_records(self):
    self.records = self.git.get_issues_records()
